from pileoffeather import pod, pof

#Define neural network model
model = pof.neuralNetwork(layers = [[784,""],[144,"relu"],[10,"sigmoid"]], name = "mnist")
...
pof.train(model, input_dataset, output_dataset, batch_size = 16, epoch_number = 2, rate = 1)
